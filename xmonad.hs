...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Switch layout (dvorak, fr, ru)
    , ((modm .|. shiftMask, xK_Escape), spawn "/home/rina/script/layout_switch.sh")

    -- Launch some apps
    , ((modm, xK_z), spawn "thunar /home/rina/")
...
--
main = xmonad $ ewmhFullscreen $ docks defaults
